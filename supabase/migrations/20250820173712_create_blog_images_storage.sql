...
-- Purpose: Set up a public Supabase storage bucket to store blog post images
-- Affected: Storage buckets, RLS policies for storage
-- Date: 2025-01-20
...
-- Policy: Allow public read access to all images in blog-images bucket
